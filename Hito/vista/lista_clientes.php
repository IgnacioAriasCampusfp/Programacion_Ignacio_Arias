            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <li><a class="dropdown-item btn-primary" href="alta_clientes.php">Añadir clientes</a></li>
                      <li><a class="dropdown-item btn-success" href="editar_clientes.php">Editar clientes</a></li>
                    </ul>
                  </li>
                  <li class="nav-item dropdown">
...
<table class="table">
  ...
  <tbody>
<!--Un for para que muestre los datos necesarios que queramos-->
  <?php foreach ($clientes as $cliente): ?>
            <tr>
                ...
                <!--Boton que sirve para eliminar usando el php de eliminar cliente mandando para usarlo en un metodo GET-->
  <a href="eliminar_cliente.php?id=<?= $cliente['id_cliente'] ?>" class="text-white text-decoration-none">Eliminar</a>
</button>
