...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $controller = new ClientesController();
     // Dependiendo de la selección del usuario, se actualiza el cliente con los paquetes adicionales extra o no
    if($PaquetesAdicionalesExtra=='paqueteExtra'){
        $resultado = $controller->actualizarCliente($id,$nombre,$apellidos, $correo, $Edad,$PlanBase,$PaquetesAdicionales,$Duracion,$precio);
    }else{
        $resultado = $controller->actualizarCliente($id,$nombre,$apellidos, $correo, $Edad,$PlanBase,$PaqueteF,$Duracion,$precio);
    }
...
<div class="container mt-5">
    ...
    <form action="editar_clientes.php" method="POST" class="row g-3">
        <div class="col-md-6">
        ...
        <!-- Seleccion de los planes base , paquetes adicionales y paquetes adicionales extra -->
        <div class="col-md-6">
